...
public final class Constants {
	...
	public static final float HEAD_OFFSET = -2.1f;
	public static final float CHEST_HEAD_OFFSET   = 2.1f;
	public static final float CHEST_HIP_OFFSET   = -2.0f;
	...
	public static final float HIP_CHEST_OFFSET = 1.1f;
